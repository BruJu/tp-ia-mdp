...
public class testRLPacman extends Application{
	private static final int TABULAIRE_CLASSIQUE = 0;
	private static final int QLAPPROX_IDENTITE = 1;
	private static final int QLAPPROX_LINEAIRE = 2;
	private static final int APPROCHE_CHOISIE = QLAPPROX_LINEAIRE;
	...
	private static void setRLAgent(int approche){
		//QLearning tabulaire classique
		if (approche == TABULAIRE_CLASSIQUE) {
	...
	private static void common(){
		testRLPacman.setRLAgent(APPROCHE_CHOISIE);
